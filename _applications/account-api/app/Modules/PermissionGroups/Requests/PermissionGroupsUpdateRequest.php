...
class PermissionGroupsUpdateRequest extends AbstractRequest
{
    protected $id;
    ...
    {
        $this->id = Request::route('nhom_quyen');
    }
    ...
    public function rules()
    {
        return [
            ...
            "store_id.*" => "integer",
            "group_name" => "required|string|unique:acc_t_permission_groups,group_name,". $this->id,
