...
export default new Router({
  routes: [
    ...
    //     children: [
    //         {
    //         path: "/cau-hinh-doanh-nghiep/to-chuc",
    //         name: "to-chuc",
    //         component: () => import("@/view/pages/to-chuc/Index.vue")
    //     },
    //       {
    //           path: "/cau-hinh-doanh-nghiep/chuc-danh",
    //           name: "chuc-danh",
    //           component: () => import("@/view/pages/chuc-danh/ChucDanhIndex.vue")
    //       },
    //         {
    //             path: "/cau-hinh-doanh-nghiep/quan-ly-user",
    //             name: "user",
    //             component: () => import("@/view/pages/user/UserIndex.vue")
    //         },
    //         // {
    //         //     path: "/cau-hinh-doanh-nghiep/quan-ly-user/them-moi",
    //         //     name: "them-moi-user",
    //         //     component: () => import("@/view/pages/user/UserCreate.vue")
    //         // },
    //         // {
    //         //     path: "/cau-hinh-doanh-nghiep/quan-ly-user/:id/cap-nhat",
    //         //     name: "cap-nhat-user",
    //         //     component: () => import("@/view/pages/user/UserEdit.vue")
    //         // },
    //       {
    //           path: "/cau-hinh-doanh-nghiep/nha-cung-cap",
    //           name: "nha-cung-cap",
    //           component: () => import("@/view/pages/nha-cung-cap/NhaCungCapIndex.vue")
    //       },
    //       {
    //           path: "/changelog",
    //           name: "changelog",
    //           component: () => import("@/view/pages/changelog/ChangeLog.vue")
    //       },
    //       {
    //           path: "/cau-hinh-doanh-nghiep/nhom-quyen",
    //           name: "nhom-quyen",
    //           component: () => import("@/view/pages/nhom-quyen/NhomQuyenIndex.vue")
    //       },
    //       {
    //         path: "/cau-hinh-doanh-nghiep/nhom-quyen/create",
    //         name: "nhom-quyen-create",
    //         component: () => import("@/view/pages/nhom-quyen/NhomQuyenCreate.vue")
    //       },
    //       {
    //         path: "/cau-hinh-doanh-nghiep/nhom-quyen/edit/:id",
    //         name: "nhom-quyen-edit",
    //         component: () => import("@/view/pages/nhom-quyen/NhomQuyenEdit.vue")
    //       },
    //       {
    //         path: "/cau-hinh-doanh-nghiep/loai-san-pham",
    //         name: "loai-san-pham",
    //         component: () => import("@/view/pages/loai-san-pham/Index.vue")
    //       },
    //       {
    //         path: "/cau-hinh-doanh-nghiep/san-pham",
    //         name: "san-pham",
    //         component: () => import("@/view/pages/san-pham/SanPhamIndex.vue")
    //       },
    //       {
    //         path: "/cau-hinh-doanh-nghiep/san-pham/create",
    //         name: "san-pham",
    //         component: () => import("@/view/pages/san-pham/SanPhamCreate.vue")
    //       },
    //       {
    //         path: "/cau-hinh-doanh-nghiep/san-pham/create-combo",
    //         name: "san-pham",
    //         component: () => import("@/view/pages/san-pham/SanPhamCreateCombo.vue")
    //       },
    //     {
    //       path: "/dashboard",
    //       name: "dashboard",
    ...
    //     name: "goodbye",
    //     path: "/goodbye",
    //     component: () => import("@/view/pages/auth/goodbye-1")
    // },
    // {
    //     name: "login",
    //     path: "/login",
